...
var tokenMod = require('../lib/token');
...
var sdk = new sdkModulo.sdk('developer', "e9cdb99fff374b5f91da4480c8dca741", "92b71cf711ca41f78362a7134f87ff65");
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
function exampleToken(sdk) {
    return new Promise(function(resolve, reject) {
        ...
        var instToken = new tokenMod.token(sdk, args).then(function(result) {
            console.log("")
            console.log("")
            console.log("Se realiza un request para la obtención de un token de pago")
            console.log("")
            console.log("")
...
//OBTENCIÓN DE TOKEN DE PAGO CON TARJETA TOKENIZADA
function exampleToken_tokenized(token, security_code) {
    return new Promise(function(resolve, reject) {
...
function exampleGetToken(sdk) {
    return new Promise(function(resolve, reject) {
        ...
        var url = 'https://developers.decidir.com/api/v1';

        var client = new Client();

        client.post(url + "/tokens", args, function(data, response) {
            resolve(data.id);
