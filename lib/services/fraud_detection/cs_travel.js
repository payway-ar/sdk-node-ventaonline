const utils = require('teamv-sdk-node/lib/utils/fraudDetectionUtils');
const logger = require('teamv-sdk-node/lib/utils/logger');

module.exports = {
    generateTravelData: function (args) {

        const VERTICAL_FIELD_NAME = 'travel_transaction_data';
        args.bill = args.bill || {};
