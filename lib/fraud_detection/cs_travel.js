module.exports = {
    travelData: function(args, items) {
        if (!args.bill) {
            args.bill = 'null'
        }
        if (!args.ship) {
        ...
        return fraud_detection = {
            ...
            device_unique_id: args.devicefingerprintid,
            travel_transaction_data: {
                reservation_code: args.reservation_code,
                third_party_booking: args.third_party_booking,
                departure_city: args.departure_city,
                final_destination_city: args.final_destination_city,
                international_flight: args.international_flight,
                frequent_flier_number: args.frequent_flier_number,
                class_of_service: args.class_of_service,
                day_of_week_of_flight: args.day_of_week_of_flight,
                week_of_year_of_flight: args.week_of_year_of_flight,
                airline_code: args.airline_code,
                code_share: args.code_share,
                decision_manager_travel: {
                    complete_route: args.complete_route,
                    journey_type: args.journey_type,
                    departure_date: {
                        departure_time: args.departure_time,
                        departure_zone: args.departure_zone
                    }
            },
            passengers: {
                email: args.email,
                ...
                phone: args.phone,
                passenger_status: args.passenger_status,
                passenger_typ: args.passenger_status
                }
             ,
             airline_number_of_passengers: args.airline_number_of_passengers,
