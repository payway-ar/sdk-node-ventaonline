...
module.exports = {
    sdk: function (environment, publicKey, privateKey) {
        ...
        this.healthcheck = function (args, callback) {
            ...
            this.forms = function (args, callback) {
                client = new Client();
                var endpoint="https://developers.decidir.com/web";
                console.log('endpoint: ' + endpoint);
            ...
            args = {
             ...
             //rocess.exit();
                ...
                client.post(endpoint + "/forms", args, function (data, response) {
            ...
            this.paymentForms = function (args, callback) {
                client = new Client();
                var endpoint="https://developers.decidir.com/web";
                console.log('endpoint: ' + endpoint);
                ...
                client.post(endpoint + "/forms" + hash + "/payments", args, function (data, response) {
