...
module.exports = {
    sdk: function(environment, publicKey, privateKey) {
        ...
        this.healthcheck = function(args, callback) {
            ...
            this.token = function(args, callback) {
                client = new Client();
                if (!args.data.amount % 1 == 0) {
                    args.data.amount = args.data.amount * 100;
                }
                ...
                client.post(endpoint + "/tokens", args, function(data, response) {
                    ...
                    data.getStatus = function(data, response) {
                        return this.status;
                    };
                    data.getToken = function() {
                        return this.id;
                    };
                    data.getCardNumberLength = function() {
                        return this.card_number_length;
                    };
                    data.getDateCreated = function() {
                    ...
                    data.getSecurityCodeLength = function() {
                    ...
                    data.getDateDue = function() {
                        return this.date_due;
                    };
                    data.getCardHolder = function() {
            ...
            this.partialRefund = function(args, id, callback) {
                ...
                client.post(endpoint + "/payments/" + id + "/refunds", args, function(data, response) {
                    if (!args.data.hasOwnProperty('amount') || args.data <= 0) {
                        ret = "Ha ocurrido un error.";
                        err = "El campo 'amount' es Requerido."
                        callback(ret, err);
