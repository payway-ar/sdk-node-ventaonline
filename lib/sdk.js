...
const fraudDetection = require('../lib/services/fraud_detection/cs_retail')
...
module.exports = {
    sdk: function (environment, publicKeyParam, privateKeyParam, grouper, developer, xConsumer = "") {
        ...
        this.fraudDetection = (args, callback) => {
            try {
                fraudDetection.retailData(endpointV2, publicKey, args, callback, grouper, developer)
            } catch (error) {
                new Error(error)
            }
        }
