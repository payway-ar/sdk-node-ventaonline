...
const cardTokens = require('../lib/services/cardToken');
...
module.exports = {
    sdk: function (environment, publicKey, privateKey) {
        ...
        this.refund = (args, id, callback) =>{
            ...
            refund.refund(endpoint, args,id,callback)
        }
        ...
        this.tokens = (args, callback) =>{
            ...
            tokens.tokens(endpoint,args,callback)
        }
        this.cardTokens = (args,user_id, callback)=>{
            console.log("de la sdk a cardToken")
            cardToken.cardTokens(endpoint,args,user_id,callback)
        }
    }
}
